...
int main(int argc, char *argv[]) {
   ...
   gs_set_begin(b, 50, &len);                            // Init a command set
      ...
      gs_color(b, 0x00, 0xFF, 0x00, 0xFF, &len);         // Set drawing color (green)
      gs_point_set(b, 4, &len);                          // Init point set (4 points)
      ...
      gs_line_set(b, 4, &len);                           // Init line set (4 lines)
         gs_line(b, 400, 100, 400, 140, &len);           //   Draw line
         gs_line(b, 400, 140, 440, 140, &len);           //   Draw line
         gs_line(b, 440, 140, 440, 100, &len);           //   Draw line
         gs_line(b, 440, 100, 400, 100, &len);           //   Draw line
